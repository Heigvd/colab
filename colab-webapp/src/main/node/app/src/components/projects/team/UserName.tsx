...
import { space_sm, text_xs, lightTextStyle, text_semibold } from "../../styling/style";
...
export interface UserNameProps {
  ...
  export default function UserName({ user, member, currentUser, className }: UserNameProps): JSX.Element {
