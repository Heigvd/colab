...
import { borderRadius, errorColor, space_L, space_M } from '../styling/style';
  ...
  return (
    <Flex align="stretch" direction="column" grow={1} className={css({ alignSelf: 'stretch' })}>
      <Tabs defaultTab="general">
        ...
        <Tab name="Advanced" label={i18n.common.advanced} invisible={project.type === 'PROJECT'}>
          <Flex
            align="stretch"
              ...
              {isProjectGlobal ? (
                <>
                  ...
                  <ConfirmDeleteOpenCloseModal
                    ...
                    message={
                      <p>
                        Are you sure you want to make this model private? Once private, no one will be able to create a project from this model except the people you share it with.
                      </p>
                    }
