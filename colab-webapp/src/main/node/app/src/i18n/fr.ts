...
export const fr: ColabTranslations = {
    ...
    authentication: {
        ...
        info: {
            ...
            updatedToSAndDataPolicy: 'Nos conditions d\'utilisation et notre politique de confidentialité ont été révisées. Veuillez prendre un moment pour les examiner et confirmer votre acceptation avant de continuer.',
        },
        error: {
