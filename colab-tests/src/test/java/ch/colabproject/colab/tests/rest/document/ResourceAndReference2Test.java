...
public class ResourceAndReference2Test extends AbstractArquillianTest {
    ...
    public void testReferenceSpreadFirstResourceThenNewData() {
        ...
        rootCardResource.setDocuments(List.of(new BlockDocument()));
        ...
        rootCardContentResource.setDocuments(List.of(new BlockDocument()));
        ...
        rootCardVariantResource.setDocuments(List.of(new BlockDocument()));
        ...
        globalCardTypeResource.setDocuments(List.of(new BlockDocument()));
        ...
        card1Resource.setDocuments(List.of(new BlockDocument()));
        ...
        card1GlobalTypeRefResource.setDocuments(List.of(new BlockDocument()));
        ...
        card1ContentResource.setDocuments(List.of(new BlockDocument()));
        ...
        card2LocalTypeResource.setDocuments(List.of(new BlockDocument()));
        ...
        card2Resource.setDocuments(List.of(new BlockDocument()));
        ...
        card2ContentResource.setDocuments(List.of(new BlockDocument()));
        ...
        anotherGlobalCardTypeResource.setDocuments(List.of(new BlockDocument()));
        ...
        anotherLocalCardTypeResource.setDocuments(List.of(new BlockDocument()));
