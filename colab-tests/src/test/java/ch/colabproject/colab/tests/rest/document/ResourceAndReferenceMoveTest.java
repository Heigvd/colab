...
public class ResourceAndReferenceMoveTest extends AbstractArquillianTest {
    ...
    public void testReferenceSpreadWhenMoveCard() {
        ...
        localTypeOneResourceCreation.setDocuments(List.of(new BlockDocument()));
        ...
        localTypeTwoResourceCreation.setDocuments(List.of(new BlockDocument()));
        ...
        rootCardResourceCreation.setDocuments(List.of(new BlockDocument()));
        ...
        card1ResourceCreation.setDocuments(List.of(new BlockDocument()));
        ...
        card2ResourceCreation.setDocuments(List.of(new BlockDocument()));
        ...
        subCard22ResourceCreation.setDocuments(List.of(new BlockDocument()));
        ...
        wanderingCardResourceCreation.setDocuments(List.of(new BlockDocument()));
        ...
        subWanderingCardResourceCreation.setDocuments(List.of(new BlockDocument()));
